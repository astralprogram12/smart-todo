...
        
        // 2.2: Create user profile in user_whatsapp
...
          })
        if (createProfileError) throw new Error('Failed to create user profile: ' + createProfileError.message)
        console.log('✅ Successfully created new user profile')

        // ✅ 2.3: CREATE AI BRAIN MEMORY (MOVED HERE)
